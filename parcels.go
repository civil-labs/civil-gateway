...
func (s *ParcelServer) GetParcelsById(
	...
	for id, meshParcel := range meshRes.Msg.Parcels {
		...
		publicParcels[id] = &publicparcelsv1.Parcel{
			...
			LandUse:                  meshParcel.LandUse,
			LandUseCode:              meshParcel.LandUseCode,
			Neighborhood:             meshParcel.Neighborhood,
			MarketArea:               meshParcel.MarketArea,
			Zoning:                   meshParcel.Zoning,
			ZoningCodes:              meshParcel.ZoningCodes,
			MarketLandValue:          meshParcel.MarketLandValue,
			AssessedLandValue:        meshParcel.AssessedLandValue,
			MarketImprovementValue:   meshParcel.MarketImprovementValue,
			...
			ImprovementSummary: &publicparcelsv1.ParcelImprovementsSummary{
				...
				LowestConditionNum:  meshParcel.ImprovementSummary.LowestConditionNum,
				HighestConditionNum: meshParcel.ImprovementSummary.HighestConditionNum,
			},
